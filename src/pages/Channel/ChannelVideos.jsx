...
import { getUserVideos } from "../../store/Slices/videoSlice.js";

function ChannelVideos() {
    const dispatch = useDispatch();
    const userId = useSelector((state) => state.user?.profileData?._id);
    const videos = useSelector((state) => state.video?.ownVideos?.docs);
    ...
    useEffect(() => {
        ...
        return () => {
            // Reset the videos if needed, but make sure you have a proper action for this
